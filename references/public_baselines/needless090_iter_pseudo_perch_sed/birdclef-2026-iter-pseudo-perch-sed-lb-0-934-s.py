...
CFG = {
    ...
    "full_cache_input_dir": Path("/kaggle/input/datasets/jaejohn/perch-meta"),
...
meta_test, scores_test_raw, emb_test = infer_perch_onnx(test_paths, verbose=True)
