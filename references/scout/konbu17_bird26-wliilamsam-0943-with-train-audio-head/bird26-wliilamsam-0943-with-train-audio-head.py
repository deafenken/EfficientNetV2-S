...
# %% cell 28
# Cell BLEND — 3-way Rank-Average Blend (ProtoSSM + SED + train_audio head)
...
blended = PROTO_W * ra + SED_W * rb + HEAD_W * rc
...
print(f"Blend: ProtoSSM {PROTO_W:.0%} + SED {SED_W:.0%} + Head {HEAD_W:.0%}")
