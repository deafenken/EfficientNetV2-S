# %% [markdown]
# # BirdCLEF 2026 — b02: e01 V2-S baseline fold-0 (LB control)
#
# Single-fold inference using `outputs/exp/e01_v2s_5fold/fold_0/swa.pt`
# (XC val_auc=0.8553, SWA averaged over last 10 epochs of 50). V2-S
# warm-started from the BirdCLEF 2025 2nd-place public BC2024 pretrained
# backbone — same recipe as the public baselines that hit LB ~0.94.
#
# **Why we submit this**: control vs eB1 (NFNet-L0 ImageNet only). eB1
# val=0.9790 collapsed to LB 0.75 (XC→soundscape domain shift). If e01
# LB > eB1 LB, BC2024 pretraining is the dominant signal and eB1's high
# val was just XC over-fit; we should drop the B-direction and go 5-fold
# on the V2-S baseline.
#
...
PKG_INPUT = Path("/kaggle/input/birdclef2026-e01-pkg-ckpt")
